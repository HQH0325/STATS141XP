    ...
    sidebarLayout(
        sidebarPanel(
          ...
          checkboxInput(inputId = "Department",
              ...
              actionButton("update", "Update View",style="color:#FFFF ; 
                           background-color:  #2774AE; border-color:  #2774AE",icon = icon("fas fa-sync")),
          br(),
          p(h5("Use Course Descrption Phrase Find Similar")),
          textInput("phrase",
                    label = "Course Description",
                    value = ""),
          actionButton("update2", "Update View",style="color:#FFFF ; 
                           background-color:  #2774AE; border-color:  #2774AE",icon = icon("fas fa-sync")),
